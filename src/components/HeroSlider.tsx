  ...
  const staticSlides: SlideItem[] = [
    {
      ...
      ctaLink: "/services",
      stats: [
        { icon: Shield, value: "50+", label: "ans d'expertise" },
        { icon: Users, value: "", label: "Leader du contrôle technique automobile" },
      ],
      duree: 6,
    },
    {
      ...
      ctaLink: "/a-propos",
      stats: [
        { icon: Shield, value: "", label: "Equipements de pointe pour un contrôle fiable" },
        { icon: MapPin, value: "", label: "29 stations repartie sur territoire national" },
      ],
      duree: 6,
    },
  ];
