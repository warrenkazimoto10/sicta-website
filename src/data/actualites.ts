...
export const ACTUALITES: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Les importateurs et acheteurs sont invités à anticiper cette démarche en prenant rendez-vous sur sicta.ci ou auprès de nos stations. Un véhicule conforme, c'est une route plus sûre pour tous.",
    ],
    date: "2024-12-10",
  ...
  },
  {
    ...
    title: "Nouvelle station de contrôle SICTA à Yopougon : ouverture et capacités accrues",
    ...
    content: [
      "La station SICTA de Yopougon Zone Industrielle a été inaugurée dans le courant du mois de décembre 2024. Ce nouveau site s'inscrit dans le plan de développement du réseau et permet de mieux couvrir la zone ouest d'Abidjan.",
      "Équipée de matériel de contrôle de dernière génération, la station peut traiter un volume accru de véhicules tout en garantissant les 123 points de contrôle réglementaires. L'équipe sur place a été formée aux protocoles et aux outils les plus récents.",
  ...
  },
  {
    ...
    excerpt: "Réserver votre créneau de contrôle technique en quelques clics depuis votre smartphone ou votre ordinateur. Disponible sur l'ensemble des stations SICTA.",
    content: [
      ...
      "Vous choisissez votre station, la date et le créneau qui vous conviennent, puis vous recevez une confirmation par e-mail et par SMS. Le jour J, présentez-vous à l'heure avec votre véhicule et votre pièce d'identité.",
  ...
  },
  {
    ...
    content: [
      ...
      "Résultat : des contrôles toujours plus homogènes, quelle que soit la station fréquentée, et une meilleure compréhension des refus ou des contre-visites. La formation continue est un pilier de notre démarche qualité ISO 9001:2015.",
    ],
    date: "2024-11-28",
  ...
  },
  {
    ...
    content: [
      ...
      "Les conditions précises (âge du véhicule, date de mise en circulation, absence de contre-visite récente, etc.) sont détaillées sur sicta.ci et disponibles auprès de nos stations. En cas de doute, un conseiller pourra vous orienter.",
    ],
    date: "2024-11-25",
  ...
  },
  {
    ...
    excerpt: "Rappel des obligations de pesée pour les transporteurs et liste des stations SICTA équipées pour le pesage. San-Pédro, Bouaké, Yamoussoukro et Plateau parmi les sites concernés.",
    content: [
      ...
      "Plusieurs stations SICTA sont équipées pour la pesée des véhicules lourds : San-Pédro, Bouaké, Yamoussoukro, Plateau (Abidjan), et d'autres selon les régions. La liste à jour est consultable sur la page Réseau de notre site.",
      "Un certificat de pesée est délivré à l'issue du contrôle. En cas de surcharge, des recommandations sont remises pour la mise en conformité. Pour planifier une pesée ou obtenir des créneaux dédiés aux professionnels, contactez la station concernée ou notre standard.",
    ],
    date: "2024-11-20",
