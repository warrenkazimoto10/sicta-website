            ...
            <div className="max-w-5xl mx-auto">
              ...
              >
                <Badge className="bg-primary/30 backdrop-blur-sm text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6 border border-white/20 hover:bg-primary/40 transition-colors">
                  <Crown className="h-3.5 w-3.5 sm:h-4 sm:w-4 mr-1.5 sm:mr-2" />
                  Service Premium SICTA
                </Badge>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <p className="text-xl text-sicta-grey-light max-w-2xl mx-auto">
                  Quatre objectifs pour une expérience premium
                </p>
              </motion.div>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              >
                ...
                <p className="text-xl text-sicta-grey-light">
                  Comment bénéficier du service VIP ?
                </p>
              </motion.div>
              ...
              <Card className="p-4 sm:p-6 md:p-8 lg:p-12 shadow-2xl border-2 border-primary/10 bg-gradient-to-br from-white to-sicta-grey/5">
                <div className="space-y-4">
                  {data.modalitesSouscription.map((modalite, index) => (
                    <motion.div
                      key={index}
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <p className="text-xl text-sicta-grey-light">
                  Les avantages exclusifs du service VIP
                </p>
              </motion.div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-sicta-grey/5 hover:bg-sicta-grey/10">
                      <TableHead className="font-bold text-sicta-grey-dark text-lg">Fonctionnalité</TableHead>
                      <TableHead className="font-bold text-sicta-grey-dark text-lg">Description</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {data.fonctionnalites.map((fonctionnalite, index) => (
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              ...
              >
                ...
                <p className="text-xl text-sicta-grey-light">
                  Nos promesses pour votre satisfaction
                </p>
              </motion.div>

              <div className="grid md:grid-cols-3 gap-6">
                {data.engagementsSicta.map((engagement, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Prêt à bénéficier du service VIP ?
              </h2>
