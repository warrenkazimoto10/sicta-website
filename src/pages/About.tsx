import { Shield, Users, Award, Globe, Calendar, CheckCircle, Mail, Phone, Building } from "lucide-react";
  ...
  return (
    <PageTransition>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-sicta-grey-dark mb-6 text-center">
              Qui sommes-nous ?
            </h2>
            <div className="space-y-4 text-sicta-grey-light leading-relaxed">
              <p>
      ...
      <section className="bg-primary/5 py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-sicta-grey-dark">{t("about.keyFigures.title")}</h2>
          </div>

          <div className="grid md:grid-cols-3 lg:grid-cols-7 gap-6 max-w-6xl mx-auto">
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">50+</div>
              <div className="text-sicta-grey-light text-sm">{t("about.keyFigures.years")}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">29</div>
              <div className="text-sicta-grey-light text-sm">{t("about.keyFigures.stations")}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">22</div>
              <div className="text-sicta-grey-light text-sm">{t("about.keyFigures.temporary")}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">04</div>
              <div className="text-sicta-grey-light text-sm">{t("about.keyFigures.mobile")}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">300K</div>
              <div className="text-sicta-grey-light text-sm">{t("about.keyFigures.inspections")}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">9Mds</div>
              <div className="text-sicta-grey-light text-sm">FCFA CA</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">300+</div>
              <div className="text-sicta-grey-light text-sm">{t("about.keyFigures.employees")}</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Contactez-nous */}
      <section className="py-20 bg-gradient-to-br from-sicta-grey/10 via-background to-primary/5">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-sicta-grey-dark mb-4">Contactez nous</h2>
            </div>
            ...
            <Card className="card-elevated">
              <div className="p-8">
                <div className="flex items-center space-x-4 mb-6">
                  <Building className="h-8 w-8 text-primary" />
                  <div>
                    <h3 className="text-2xl font-bold text-sicta-grey-dark">SICTA – Siège</h3>
                    <p className="text-sicta-grey-light">Abidjan, Côte d'Ivoire, Zone 4C</p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-sicta-grey-dark">Email</p>
                      <p className="text-sicta-grey-light">infos.sicta@sicta.ci</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-sicta-grey-dark">Téléphone</p>
                      <p className="text-sicta-grey-light">27 21 21 29 90</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-sicta-grey-dark">N° vert</p>
                      <p className="text-sicta-grey-light">800 800 41</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-sicta-grey-dark">Site web</p>
                      <p className="text-sicta-grey-light">www.sicta.ci</p>
                    </div>
                  </div>
                </div>
              </div>
