  ...
  return (
    <PageTransition>
      ...
      <div className="w-full min-h-screen bg-white">
        ...
        {/* Hero */}
        <section className="border-b border-gray-100 bg-gradient-to-br from-primary/5 via-background to-secondary/10 py-16 md:py-20">
          <div className="container mx-auto px-4">
            <motion.div
              ...
              className="max-w-2xl"
            >
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-sicta-grey-dark tracking-tight leading-[1.05]">
                Actualités
              </h1>
            </motion.div>
          </div>
        ...
        {isLoading ? (
          ...
          <>
            {/* À LA UNE */}
            {featuredArticle && (
              <section className="py-14 md:py-18 border-b border-gray-100">
                <div className="container mx-auto px-4">
                  <div className="max-w-7xl mx-auto">
                    ...
                    <Card className="overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-500 group">
                      <article className="grid lg:grid-cols-2 gap-0">
                        {/* Image gauche */}
                        <div className="relative aspect-[4/3] lg:aspect-auto lg:min-h-[460px] overflow-hidden bg-gray-100">
                        ...
                        <div className="flex flex-col justify-center p-8 lg:p-12 bg-white">
                          <div className="flex items-center gap-3 mb-5">
                            ...
                            {featuredArticle.tendance && (
                              <Badge variant="outline" className="border-orange-200 text-orange-600 gap-1">
                          ...
                          <Link to={`/actualites/${featuredArticle.slug}`}>
                            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-sicta-grey-dark leading-tight mb-4 hover:text-primary transition-colors">
                              {featuredArticle.titre}
                            </h2>
                          </Link>

                          {featuredArticle.extrait && (
                            <p className="text-sicta-grey-light leading-relaxed mb-6 text-base lg:text-lg line-clamp-3">
                              {featuredArticle.extrait}
                            </p>
                          )}

                          <div className="flex items-center gap-4 text-sm text-sicta-grey-light pb-6 mb-6 border-b border-gray-100">
              ...
              <div className="container mx-auto px-4">
                <div className="max-w-7xl mx-auto">
                  <div className="flex items-center justify-between mb-10">
                    <div>
                      <h2 className="text-2xl md:text-3xl font-bold text-sicta-grey-dark">
                        Toutes les actualités
                      </h2>
                      <p className="text-sm text-sicta-grey-light mt-1">
                        {allArticles.length} article{allArticles.length > 1 ? "s" : ""} disponible{allArticles.length > 1 ? "s" : ""}
                      </p>
                    </div>
                  </div>
