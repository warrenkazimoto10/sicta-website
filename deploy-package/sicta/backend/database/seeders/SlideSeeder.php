    ...
    public function run(): void
    {
        $slides = [
            [
                ...
                'description' => "Société Ivoirienne de Contrôle Technique Automobiles et Industriels, SICTA entre dans une nouvelle phase de développement sous l'impulsion de Mayelia Participations. Leader incontesté depuis 1974.",
