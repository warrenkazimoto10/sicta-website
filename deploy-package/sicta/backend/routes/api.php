...
Route::prefix('v1')->group(function () {
    Route::get('/reseau-map', [\App\Http\Controllers\Api\MapController::class, 'index']);
    ...
    Route::get('/team', [\App\Http\Controllers\Api\AboutController::class, 'team']);
    Route::get('/history', [\App\Http\Controllers\Api\AboutController::class, 'history']);
});
